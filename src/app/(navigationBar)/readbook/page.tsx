...
const ReadBookPage = async () => {
  ...
  console.timeEnd('join으로 가져오기');

  // console.time('promise로 가져오기');
  ...
  // const clubDataPromises = members.map(async (member, i) => {
